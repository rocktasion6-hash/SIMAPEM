<x-app-layout>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-l-4 border-blue-500">
        <div class="p-6 text-gray-900">
            <div class="text-sm font-medium text-gray-500 uppercase tracking-wider">Total Laporan</div>
            <div class="flex items-center mt-1">
                <div class="text-3xl font-bold text-gray-800">{{ $stats['total'] }}</div>
                <span class="ml-2 text-xs text-gray-400">Aduan Masuk</span>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-l-4 border-red-500">
        <div class="p-6 text-gray-900">
            <div class="text-sm font-medium text-gray-500 uppercase tracking-wider">Menunggu</div>
            <div class="flex items-center mt-1">
                <div class="text-3xl font-bold text-gray-800">{{ $stats['pending'] }}</div>
                <span class="ml-2 text-xs text-gray-400">Perlu Dicek</span>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-l-4 border-yellow-500">
        <div class="p-6 text-gray-900">
            <div class="text-sm font-medium text-gray-500 uppercase tracking-wider">Dalam Proses</div>
            <div class="flex items-center mt-1">
                <div class="text-3xl font-bold text-gray-800">{{ $stats['process'] }}</div>
                <span class="ml-2 text-xs text-gray-400">Sedang Dikerjakan</span>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-l-4 border-green-500">
        <div class="p-6 text-gray-900">
            <div class="text-sm font-medium text-gray-500 uppercase tracking-wider">Selesai</div>
            <div class="flex items-center mt-1">
                <div class="text-3xl font-bold text-gray-800">{{ $stats['resolved'] }}</div>
                <span class="ml-2 text-xs text-gray-400">Tuntas</span>
            </div>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 bg-white p-6 rounded-xl shadow-sm">
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y">
                            ...
                            <tr>
                                <td class="px-4 py-4 font-medium text-gray-800">{{ $stat->name }}</td>
                ...
                <div class="bg-indigo-900 p-6 rounded-xl shadow-sm text-white">
                    <h3 class="font-bold mb-4">Informasi Sistem</h3>
                    <div class="space-y-4 text-sm opacity-90">
                        <p>Dashboard ini diperbarui secara real-time berdasarkan aktivitas petugas di lapangan.</p>
                        <hr class="opacity-20">
                        <div>
                            <p class="font-bold text-indigo-300">Target Penyelesaian:</p>
                            <p>Maksimal 3x24 jam sejak laporan diverifikasi.</p>
                        </div>

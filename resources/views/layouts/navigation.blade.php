@php
    ...
    $dashboardRoute = match($role) {
        ...
        'kadis' => route('kadis.dashboard'),
        default => url('/'),
    };

    // Menentukan nama tampilan di menu (misal: "Laporan Saya" untuk warga)
    $dashboardLabel = match($role) {
        'warga' => __('Laporan Saya'),
        'fo' => __('Verifikasi Laporan'),
        'kasi' => __('Penugasan'),
        'pelaksana' => __('Tugas Saya'),
        'kadis' => __('Dashboard Monitoring'),
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                ...
                <div class="font-medium text-sm text-gray-500">{{ Auth::user()->email }} ({{ ucfirst($role) }})</div>
            </div>
